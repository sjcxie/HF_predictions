...
ave.last.df <- readxl::read_excel('~/Desktop/datasets/processed/GBTM_data/last and average labs data.xlsx') %>% select(ends_with("_last"), ends_with("_average"))
...
```{r}
ctb.last.ave.df <- cbind(ctb.df, ave.last.df)
train <- ctb.last.ave.df[train.ind, ]
test <- ctb.last.ave.df[-train.ind, ]
```
...
# names(ctb.gr.df)[names(ctb.gr.df) == "factor(lab.gbtm.df$`_traj_Group`)"] <- "group4_k"
# names(ctb.gr.df)[names(ctb.gr.df) == "factor(lab.gbtm.df$`_traj_Group`)"] <- "group4_multivar"
# names(ctb.gr.df)[names(ctb.gr.df) == "factor(lab.gbtm.df$`_traj_Group`)"] <- "group_multivar_sig"
# names(ctb.gr.df)[names(ctb.gr.df) == "factor(lab.gbtm.df$`_traj_Group`)"] <- "group_multivar2"
# names(ctb.gr.df)[names(ctb.gr.df) == "factor(lab.gbtm.df$`_traj_Group`)"] <- "group_egfr_na"
# names(ctb.gr.df)[names(ctb.gr.df) == "factor(lab.gbtm.df$`_traj_Group`)"] <- "group_hgb2"
# names(ctb.gr.df)[names(ctb.gr.df) == "factor(lab.gbtm.df$`_traj_Group`)"] <- "group_k2"
# names(ctb.gr.df)[names(ctb.gr.df) == "factor(lab.gbtm.df$`_traj_Group`)"] <- "group_wbc2"
# names(ctb.gr.df)[names(ctb.gr.df) == "factor(lab.gbtm.df$`_traj_Group`)"] <- "group_na2"
# names(ctb.gr.df)[names(ctb.gr.df) == "factor(lab.gbtm.df$`_traj_Group`)"] <- "group_k_wbc"
# names(ctb.gr.df)[names(ctb.gr.df) == "factor(lab.gbtm.df$`_traj_Group`)"] <- "group_egfr_na"
# names(ctb.gr.df)[names(ctb.gr.df) == "factor(lab.gbtm.df$`_traj_Group`)"] <- "group_egfr_na_2"
# names(ctb.gr.df)[names(ctb.gr.df) == "factor(lab.gbtm.df$`_traj_Group`)"] <- "group_wbc_hgb"
# names(ctb.gr.df)[names(ctb.gr.df) == "factor(lab.gbtm.df$`_traj_Group`)"] <- "group_multivar_glucose"
# names(ctb.gr.df)[names(ctb.gr.df) == "factor(lab.gbtm.df$`_traj_Group`)"] <- "group_multivar3"
# names(ctb.gr.df)[names(ctb.gr.df) == "factor(lab.gbtm.df$`_traj_Group`)"] <- "group_multivar4"
# names(ctb.gr.df)[names(ctb.gr.df) == "factor(lab.gbtm.df$`_traj_Group`)"] <- "group_multivar5"
# names(ctb.gr.df)[names(ctb.gr.df) == "factor(lab.gbtm.df$`_traj_Group`)"] <- "group_multivar6"

names(ctb.gr.df)[names(ctb.gr.df) == "factor(lab.gbtm.df$`_traj_Group`)"] <- "group_egfr_3"
```
...
```{r model 6, echo=TRUE }
ctb.glm.fit6 <- glm(CTB ~ AGE_ADMISSION + BP_DIASTOLIC + FEMALE + RACE_White + TOBACCO_Never + INSUR_Commercial + COPD_HST + CCI_PERIPHERAL_VASC + NOAC_00 + INSULIN_00 + group_egfr, data = train, family = binomial)
summary(ctb.glm.fit6)
...
```{r}
ctb.glm.fit6 <- glm(CTB ~ AGE_ADMISSION + BP_DIASTOLIC + FEMALE + RACE_White + INSUR_Commercial + COPD_HST + CCI_PERIPHERAL_VASC + NOAC_00 + INSULIN_00  + group_egfr + group_na + EGFR_average + EGFR_last, data = train, family = binomial)
summary(ctb.glm.fit6)
